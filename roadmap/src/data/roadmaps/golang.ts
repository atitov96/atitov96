  ...
  items: [
    {
      ...
      description: 'Базовые концепции Go: переменные, циклы, условные операторы, функции и типы данных',
      type: 'concept',
      resources: [
        {
          type: 'official',
      ...
      children: [
        ...
        },
        {
          id: 'functions',
          title: 'Функции',
          description: 'Объявление функций, параметры, возвращаемые значения, множественные возвращаемые значения',
          type: 'concept',
          resources: []
        }
      ]
    ...
    },
    {
      ...
      description: 'Углубленное изучение возможностей Go для улучшения производительности и читаемости кода',
      type: 'concept',
      resources: [
            {
              type: 'article',
          ...
          children: [
            {
              id: 'go-modules',
              title: 'Go Modules',
              description: 'Система управления зависимостями и версионирования в Go',
              type: 'concept',
              resources: [
                {
                  type: 'official',
